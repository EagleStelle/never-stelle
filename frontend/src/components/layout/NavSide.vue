...
<template>
 ...
 >
 <div class="flex items-center w-full mb-3 h-10" :class="isExpanded ?'px-1.5 justify-between':'justify-center'">
 <a v-if="isExpanded" href="/" class="inline-flex items-center min-w-0 gap-3 text-white [.light-mode_&]:text-black hover:text-white [.light-mode_&]:hover:text-black leading-none no-underline" aria-label="Never Stelle Home">
 <img src="/assets/logo.png" alt="" class="w-8 h-8 shrink-0" />
 <span class="whitespace-nowrap overflow-hidden font-display font-bold text-white [.light-mode_&]:text-black text-xl tracking-tight">Never Stelle</span>
 </a>
 ...
 :class="isExpanded ?'w-8 h-8 rounded-lg bg-transparent shrink-0':'w-10 h-10 rounded-lg bg-transparent'"
 ...
 :key="item.key"
 type="button"
 class="inline-flex items-center rounded-xl bg-transparent text-white [.light-mode_&]:text-black leading-none transition-all duration-300 ease-glass active:scale-[0.97] hover:text-white [.light-mode_&]:hover:text-black aria-pressed:bg-accent aria-pressed:text-black"
 ...
 <button
 type="button"
 class="inline-flex items-center rounded-xl bg-transparent text-white [.light-mode_&]:text-black leading-none transition-all duration-300 ease-glass active:scale-[0.97] hover:text-white [.light-mode_&]:hover:text-black"
 :class="isExpanded ?'w-full flex-row justify-start px-3.5 h-10 gap-3':'w-10 h-10 justify-center'"
